"""
Django settings for dapse_44023 project.
...
WSGI_APPLICATION = 'dapse_44023.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dapse_44023 API",
    "DESCRIPTION": "API documentation for dapse_44023 App",
    "VERSION": "v1",
}
